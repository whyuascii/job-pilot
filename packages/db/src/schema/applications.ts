...
export const applications = pgTable('applications', {
  ...
  tailoredResumeId: text('tailored_resume_id').references(() => resumes.id, { onDelete: 'set null' }),
...
export const answerBank = pgTable('answer_bank', {
  ...
  index('answer_bank_tenant_id_category_idx').on(table.tenantId, table.category),
]);
...
export const outcomes = pgTable('outcomes', {
  ...
  index('outcomes_application_id_idx').on(table.applicationId),
]);
